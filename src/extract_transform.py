...
def create_order_df(df, product_df, last_id):
...
def third_nf(df, last_id):
    ...
    order_df = create_order_df(df, product_df, last_id)
...
def handler(event, context):
    ...
    resp = sqs.send_message(
        ...
        MessageBody=(
            'csv file that has been processed'
        ),
        MessageGroupId='1'
    )
